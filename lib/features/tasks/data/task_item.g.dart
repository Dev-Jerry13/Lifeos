...
const TaskItemSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'priority': PropertySchema(
      ...
      name: r'priority',
      type: IsarType.byte,
      enumMap: _TaskItempriorityEnumValueMap,
    ),
...
TaskItem _taskItemDeserialize(
  ...
  object.priority =
      _TaskItempriorityValueEnumMap[reader.readByteOrNull(offsets[3])] ??
          TaskPriority.low;
...
P _taskItemDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (_TaskItempriorityValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _TaskItempriorityEnumValueMap = {
  'low': 0,
  'medium': 1,
  'high': 2,
};
const _TaskItempriorityValueEnumMap = {
  0: TaskPriority.low,
...
extension TaskItemQueryFilter
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryEqualTo(
    String value, {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'category',
        value: '',
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> categoryIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'category',
        value: '',
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> dueDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'dueDate',
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> dueDateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> dueDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> dueDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> priorityEqualTo(
      TaskPriority value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'priority',
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> priorityGreaterThan(
    TaskPriority value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> priorityLessThan(
    TaskPriority value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> priorityBetween(
    TaskPriority lower,
    TaskPriority upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskItemQuerySortBy on QueryBuilder<TaskItem, TaskItem, QSortBy> {
  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByCategoryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.desc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByDueDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dueDate', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByDueDateDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByPriority() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priority', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByPriorityDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskItemQuerySortThenBy
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByCategoryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.desc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByDueDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dueDate', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByDueDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dueDate', Sort.desc);
    });
  }
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByPriority() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priority', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByPriorityDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'priority', Sort.desc);
    });
  }
...
extension TaskItemQueryWhereDistinct
  ...
  QueryBuilder<TaskItem, TaskItem, QDistinct> distinctByCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QDistinct> distinctByDueDate() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QDistinct> distinctByPriority() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskItemQueryProperty
  ...
  QueryBuilder<TaskItem, String, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'category');
    });
  }

  QueryBuilder<TaskItem, DateTime, QQueryOperations> dueDateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskPriority, QQueryOperations> priorityProperty() {
    return QueryBuilder.apply(this, (query) {
