...
void _goalSerialize(
  ...
  writer.writeLong(offsets[0], object.milestones);
...
Goal _goalDeserialize(
  ...
  final object = Goal();
  object.id = id;
  object.milestones = reader.readLong(offsets[0]);
...
extension GoalQueryFilter on QueryBuilder<Goal, Goal, QFilterCondition> {
  ...
  QueryBuilder<Goal, Goal, QAfterFilterCondition> milestonesEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Goal, Goal, QAfterFilterCondition> milestonesGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Goal, Goal, QAfterFilterCondition> milestonesLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Goal, Goal, QAfterFilterCondition> milestonesBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension GoalQuerySortBy on QueryBuilder<Goal, Goal, QSortBy> {
  QueryBuilder<Goal, Goal, QAfterSortBy> sortByMilestones() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'milestones', Sort.asc);
    });
  }

  QueryBuilder<Goal, Goal, QAfterSortBy> sortByMilestonesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'milestones', Sort.desc);
    });
  }
...
extension GoalQuerySortThenBy on QueryBuilder<Goal, Goal, QSortThenBy> {
  ...
  QueryBuilder<Goal, Goal, QAfterSortBy> thenByMilestones() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'milestones', Sort.asc);
    });
  }

  QueryBuilder<Goal, Goal, QAfterSortBy> thenByMilestonesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'milestones', Sort.desc);
    });
  }
...
extension GoalQueryWhereDistinct on QueryBuilder<Goal, Goal, QDistinct> {
  QueryBuilder<Goal, Goal, QDistinct> distinctByMilestones() {
    return QueryBuilder.apply(this, (query) {
...
extension GoalQueryProperty on QueryBuilder<Goal, Goal, QQueryProperty> {
  ...
  QueryBuilder<Goal, int, QQueryOperations> milestonesProperty() {
    return QueryBuilder.apply(this, (query) {
