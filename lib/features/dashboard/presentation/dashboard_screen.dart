...
class DashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final health = ref.watch(seedHealthProvider);
    ...
    return ListView(
      ...
      children: [
        ...
        AnimatedEntrance(
          ...
          child: Row(
          children: [
            Expanded(child: _MetricCard(title: 'Water', value: '${health.first.value}/${health.first.target}L', icon: Icons.water_drop_rounded)),
