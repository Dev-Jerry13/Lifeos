  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return PremiumCard(
          onTap: () => ref.read(habitsControllerProvider.notifier).toggle(habit.name),
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                ...
                const Spacer(),
                Icon(habit.completedToday ? Icons.check_circle_rounded : Icons.radio_button_unchecked_rounded, size: 18),
              ]),
